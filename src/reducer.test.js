...
describe('reducer', () => {
    ...
    describe('makeGuess', () => {
        it('Should make a guess', () => {
            ...
            expect(state.guesses).toEqual([25, 60, 80, 99]);
            expect(state.feedback).toEqual("You're Hot!");

            state = reducer(state, makeGuess(100));
            expect(state.guesses).toEqual([25, 60, 80, 99, 100]);
    ...
    it('Can generate aural updates', () => {
        ...
        expect(state.auralStatus).toEqual(
            "Here's the status of the game right now: You're Warm. You've made 3 guesses. In order of most- to least-recent, they are: 81, 24, 8"
        );
    });
});